        ...
        <aside className='fixed inset-y-0 left-0 z-10 hidden w-14 flex-col border-r bg-background sm:flex'>
              ...
              <TooltipTrigger asChild>
                <Link
                  ...
                  className={`flex h-9 w-9 items-center justify-center rounded-lg ${
                    pathname === '/jobs' ? 'bg-accent text-accent-foreground' : 'text-muted-foreground'
                  } transition-colors hover:text-foreground md:h-8 md:w-8`}>
                  <BriefcaseBusiness className='h-5 w-5' />
                  <span className='sr-only'>{NAVIGATION_LABELS.JOBS}</span>
                </Link>
              </TooltipTrigger>
              <TooltipContent side='right'>{NAVIGATION_LABELS.JOBS}</TooltipContent>
            </Tooltip>
            <Tooltip>
              <TooltipTrigger asChild>
                <Link
                  href='/invoices'
                  className={`flex h-9 w-9 items-center justify-center rounded-lg ${
                    pathname === '/invoices' ? 'bg-accent text-accent-foreground' : 'text-muted-foreground'
                  } transition-colors hover:text-foreground md:h-8 md:w-8`}>
                  <NotepadText className='h-5 w-5' />
                  <span className='sr-only'>{NAVIGATION_LABELS.INVOICES}</span>
                </Link>
              </TooltipTrigger>
              <TooltipContent side='right'>{NAVIGATION_LABELS.INVOICES}</TooltipContent>
            </Tooltip>
            <Tooltip>
              <TooltipTrigger asChild>
                <Link
                  href='/quote'
                  className={`flex h-9 w-9 items-center justify-center rounded-lg ${
                    pathname === '/quote' ? 'bg-accent text-accent-foreground' : 'text-muted-foreground'
                  } transition-colors hover:text-foreground md:h-8 md:w-8`}>
                  <Quote className='h-5 w-5' />
                  <span className='sr-only'>{NAVIGATION_LABELS.QUOTATIONS}</span>
                </Link>
              </TooltipTrigger>
              <TooltipContent side='right'>{NAVIGATION_LABELS.QUOTATIONS}</TooltipContent>
            </Tooltip>
          </nav>
          <nav className='mt-auto flex flex-col items-center gap-4 px-2 sm:py-5'>
            <Tooltip>
              ...
              <TooltipContent side='right'>{NAVIGATION_LABELS.SETTINGS}</TooltipContent>
            </Tooltip>
          </nav>
        </aside>
                ...
                <nav className='grid gap-6 text-lg font-medium'>
                  ...
                  <Link
                    ...
                    className={`flex items-center gap-4 px-2.5 ${
                      pathname === '/jobs' ? 'text-foreground' : 'text-muted-foreground hover:text-foreground'
                    }`}
                    onClick={handleLinkClick}>
                    <BriefcaseBusiness className='h-5 w-5' />
                  ...
                  <Link
                    href='/invoices'
                    className={`flex items-center gap-4 px-2.5 ${
                      pathname === '/invoices' ? 'text-foreground' : 'text-muted-foreground hover:text-foreground'
                    }`}
                    onClick={handleLinkClick}>
                    <NotepadText className='h-5 w-5' />
                  ...
                  <Link
                    href='/quote'
                    className={`flex items-center gap-4 px-2.5 ${
                      pathname === '/quote' ? 'text-foreground' : 'text-muted-foreground hover:text-foreground'
                    }`}
                    onClick={handleLinkClick}>
                    <Quote className='h-5 w-5' />
