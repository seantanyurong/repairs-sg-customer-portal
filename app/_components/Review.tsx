...
export default function ReviewSection() {
  const items = [
    <div key="review1" className="flex justify-center items-center h-full p-6 bg-white shadow-lg rounded-lg">
    ...
    <div key="review2" className="flex justify-center items-center h-full p-6 bg-white shadow-lg rounded-lg">
      <div className="flex flex-col items-center">
        <div className="flex items-center mb-4">
          <Star className="text-primary w-5 h-5" />
          <Star className="text-primary w-5 h-5" />
    ...
    <div key="review3" className="flex justify-center items-center h-full p-6 bg-white shadow-lg rounded-lg">
      <div className="flex flex-col items-center">
        <div className="flex items-center mb-4">
          <Star className="text-primary w-5 h-5" />
          <Star className="text-primary w-5 h-5" />
    ...
    <div key="review4" className="flex justify-center items-center h-full p-6 bg-white shadow-lg rounded-lg">
      <div className="flex flex-col items-center">
        <div className="flex items-center mb-4">
          <Star className="text-primary w-5 h-5" />
          <Star className="text-primary w-5 h-5" />
    ...
    <div key="review5" className="flex justify-center items-center h-full p-6 bg-white shadow-lg rounded-lg">
      <div className="flex flex-col items-center">
        <div className="flex items-center mb-4">
          <Star className="text-primary w-5 h-5" />
          <Star className="text-primary w-5 h-5" />
        ...
        <p className="text-lg mb-4">
          &quot;The technician came and fixed my wall socket and it took them just about 15mins to do the job. Though it was fast and easy fix the technician got the job done properly as well as making sure it&apos;s working well and safe. Really great job and would definitely reach out to you guys for any future fixes. Thanks very much.&quot;
        </p>
